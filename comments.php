...
<strong><?php comment_author_link() ?></strong> | <?php comment_date('d-M-y') ?> at <?php comment_time('g:i a') ?> | <a href="#comment-<?php comment_ID() ?>" title="Permalink to this comment" rel="permalink">Permalink</a> <?php edit_comment_link('Edit', '| ', ''); ?></p>
